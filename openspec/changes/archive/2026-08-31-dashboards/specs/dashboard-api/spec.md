...
Read-only reporting endpoint aggregating existing CRM data into KPIs with period comparison, breakdowns, activity metrics and neglected accounts, scoped by role on the server.
