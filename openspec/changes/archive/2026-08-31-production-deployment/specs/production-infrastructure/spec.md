...
The production runtime: a standalone hardened Compose file, Caddy terminating HTTPS for a single origin, strict secret handling and documented server prerequisites.
