...
## Purpose
Persistence and invariants of the product catalogue: product families per division, products identified by the Sage code (normalised, unique), kinds, exact prices, brand-division consistency, indexes, seed and the import upsert contract.
