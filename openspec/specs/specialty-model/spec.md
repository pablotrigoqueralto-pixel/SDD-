...
## Purpose
The medical specialties catalogue: table, seed of the twelve business specialties (insert-only by code so admin edits survive), uniqueness and activation rules, the contact link and the migration away from the contact's commercial division.
