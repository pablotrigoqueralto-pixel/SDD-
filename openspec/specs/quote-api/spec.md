...
## Purpose
REST endpoints for quotes under the account visibility rule inherited through the opportunity: scoped list of current versions, draft editing with optimistic locking, send with PDF and Graph mail, accept/reject/revise, PDF download and quote settings administration.
