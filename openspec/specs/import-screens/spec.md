...
## Purpose
The import screens for admin and back office: file picker, dry-run preview table with error rows first, confirmation with pending counts and a client-generated error report download.
