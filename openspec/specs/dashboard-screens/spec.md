...
## Purpose
The Informes page: KPI cards with comparison deltas, CSS-bar visualisations for pipeline and breakdowns, activity and neglected-accounts sections with a month/quarter/YTD selector, plus the Informes card in Más.
