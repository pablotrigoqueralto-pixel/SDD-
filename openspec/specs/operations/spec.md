...
## Purpose
Production operations: nightly dumps with external copy and a rehearsed restore, uptime alerting on /health, the Microsoft Graph go-live tenant procedure, the idempotent first-admin bootstrap and the ordered go-live checklist.
