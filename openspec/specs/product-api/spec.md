...
## Purpose
REST endpoints for the global product catalogue and product families: searchable paginated list, detail, create/update/activate with optimistic locking, role-gated cost price and OpenAPI contract.
