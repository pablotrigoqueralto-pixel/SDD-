...
export const routes = {
  ...
  opportunityNew: '/oportunidades/nueva',
  opportunity: (id: string) => `/oportunidades/${id}`,
  ...
  quoteEdit: (id: string) => `/presupuestos/${id}/editar`,
  quoteSend: (id: string) => `/presupuestos/${id}/enviar`,
  quoteAccept: (id: string) => `/presupuestos/${id}/aceptar`,
  quoteReject: (id: string) => `/presupuestos/${id}/rechazar`,
  adminQuoteSettings: '/admin/presupuestos',
  catalogue: '/catalogo',
